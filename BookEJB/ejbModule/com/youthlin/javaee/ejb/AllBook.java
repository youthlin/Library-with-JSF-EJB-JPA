...
public class AllBook implements AllBookRemote {
	...
	private static AllBook instance;

	@PersistenceContext(unitName = "BookEJB")
	private EntityManager manager;

	public static AllBook getInstance() {
		if (instance == null) {
			instance = new AllBook();
		}
		return instance;
	}

	public AllBook() {
		allBook = new ArrayList<Map<String, Object>>();
	}
	...
	public boolean addBook(Map<String, Object> book) {
		...
		if (book.containsKey("author"))
			author = ((List<String>) book.get("author")).toString();
